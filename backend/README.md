...
## Project Structure
    ...
    ├── throbbing_shadow_38703  # Django project configurations
...
1. Clone this repo and `cd throbbing_shadow_38703`
...
2. Clone this repo and `cd throbbing_shadow_38703`
